...
const mainColClassName =
  'col-md-7 col-lg-8 col-xl-9 px-5 py-6 border-top border-md-top-0 bg-gray-light'
type MainColProps = {
  repos: ReposObj
  skills: SkillsObj
      ...
      <div className="mx-auto" style={{ maxWidth: 960 }}>
        ...
        <div className="d-flex flex-wrap gutter-condensed mb-4">
          {Object.entries(repos)
            ...
            .map((r) => (
              <Repo repo={r[1]} key={r[0]} />
            ))}
        </div>

        <h2>{titles.skills || 'My Skills'}</h2>
        <Subtitle
          configTitle={titles.skills_sub}
        ...
        {history && (
          <>
            ...
            <Subtitle
              configTitle={titles.history_sub}
...

            {
              <ReactMarkdown
                children={history}
                className="bg-white f4 border border-gray-light px-4 pt-2 mb-4"
              />
            }
          </>
        )}
        ...
        {others && (
          <>
            ...
            <Subtitle configTitle={titles.others_sub} defaultTitle="" />

            {
              <ReactMarkdown
                children={others}
                className="bg-white f4 border border-gray-light px-4 pt-2"
              />
            }
          </>
        )}
