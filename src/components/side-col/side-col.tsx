...
const sideColClassName =
  'flex-self-stretch border-md-right border-gray-light bg-white col-md-5 col-lg-4 col-xl-3 px-4 px-md-6 px-lg-7 py-6'
    ...
    <div className={sideColClassName}>
      <div className="width-full top-6" style={{ position: 'sticky' }}>
        <img
          ...
          style={{ maxWidth: 150 }}
        />
        <h1 className="mb-2 lh-condensed break-text">
        ...
        <div className="f4 mb-6">
          ...
          {user.email && (
            <div className={metadataStyles}>
              ...
              />
              {email[0]}
              <span className="d-none">shine*spa&m</span>
              {email[1]}
          ...
          {!_.isEmpty(user.social_media) && (
            <div className="d-flex flex-wrap flex-items-start">
              {Object.entries(user.social_media).map((s) => (
                <SocialMediaLink
                  mediaKey={s[0]}
                  mediaVal={s[1]}
